...
<div class="jumbotron py-0">
    <div class="container loginContainer">
        ...
        <div class="lead py-4"><strong>Order management system for Lithuanian recovery service.<br>
            <br>
            HOW TO USE THIS SERVICE?<br>
            <br>
            It's simple as my life. There two types of accounts: admins(call center staff) and simple users(tow truck drivers).<br>
            <br>
            ...
            for "Direction" field you should use Google My Maps service.<br>
            For new order, press "ALL ORDERS" -> "NEW" (If you on "ACTIVE ORDERS" tab).<br>
            ...
            you can refresh this and get actual info.<br>
            <br>
            ...
            <br>On the top panel drivers have status button - "Ready" or "Not Ready",
